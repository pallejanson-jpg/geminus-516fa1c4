    ...
    <div className="space-y-6">
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-medium">Röststyrning</h4>
              <p className="text-xs text-muted-foreground">
                Aktivera mikrofon för röstkommandon
              </p>
            </div>
          </div>
          <Switch
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <Label className="text-sm font-medium">Mikrofonkänslighet</Label>
            <p className="text-xs text-muted-foreground">
              Justera hur känslig mikrofonen är
            </p>
          </div>
        </div>
      ...
      <div className="border rounded-lg p-4 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <Label className="text-sm font-medium">Feedback-volym</Label>
            <p className="text-xs text-muted-foreground">
              Volym på ljud-feedback efter kommandon
            </p>
          </div>
        </div>
        <div className="flex items-center gap-4">
