...
const MobileViewerOverlay: React.FC<MobileViewerOverlayProps> = ({
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between p-2 bg-gradient-to-b from-background/90 to-transparent" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 12px)' }}>
