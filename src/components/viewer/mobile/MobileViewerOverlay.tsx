...
const MobileViewerOverlay: React.FC<MobileViewerOverlayProps> = ({
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between p-2 bg-gradient-to-b from-background/90 via-background/60 to-transparent" style={{ paddingTop: 'calc(max(env(safe-area-inset-top, 0px), 20px) + 8px)' }}>
