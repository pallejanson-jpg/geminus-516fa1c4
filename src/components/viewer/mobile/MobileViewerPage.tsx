        ...
        <DrawerContent className="max-h-[92dvh]">
          ...
          {subSheet === 'settings' && (
            <>
              ...
              <div className="px-4 pb-[calc(env(safe-area-inset-bottom,0px)+24px)] space-y-5" style={{ overscrollBehavior: 'contain' }}>
                {/* Clip height */}
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                ...
                {/* Navigation Speed — unified with desktop (VisualizationToolbar) */}
                <MobileNavigationSpeed navSpeed={navSpeed} setNavSpeed={setNavSpeed} />
              </div>
            </>
          )}
