...
interface GeminusBaseIssueOverlayProps {
  buildingFmGuid: string;
  buildingName?: string;
  source: 'fma_plus' | '2d_geminus_base';
  contextMetadata?: Record<string, any>;
}

const GeminusBaseIssueOverlay: React.FC<GeminusBaseIssueOverlayProps> = ({
  buildingFmGuid,
  buildingName,
  source,
  contextMetadata,
  ...
  const handleSubmit = async (data: {
    ...
    try {
      ...
      console.error('[GeminusBaseIssueOverlay] Error creating issue:', err);
...
export default GeminusBaseIssueOverlay;
