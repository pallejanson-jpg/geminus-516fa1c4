...
import { GeminusBaseSearchResult, useGeminusBaseApi } from '@/hooks/useGeminusBaseApi';

interface GeminusBaseSearchProps {
  onSelect: (result: GeminusBaseSearchResult) => void;
}

const GeminusBaseSearch: React.FC<GeminusBaseSearchProps> = ({ onSelect }) => {
  const { searchObjects, loading } = useGeminusBaseApi();
  const [query, setQuery] = useState('');
  const [results, setResults] = useState<GeminusBaseSearchResult[]>([]);
      ...
      <div className="p-3 border-b border-border">
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search objects in Geminus Base..."
...
export default GeminusBaseSearch;
