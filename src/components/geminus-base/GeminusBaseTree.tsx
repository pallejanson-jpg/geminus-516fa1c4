...
interface GeminusBaseTreeProps {
  ...
  onSelect: (node: GeminusBaseNode, path: GeminusBaseNode[]) => void;
}
...
interface TreeNodeProps {
  node: GeminusBaseNode;
  depth: number;
  selectedGuid: string | null;
  path: GeminusBaseNode[];
  onSelect: (node: GeminusBaseNode, path: GeminusBaseNode[]) => void;
}
...
const GeminusBaseTree: React.FC<GeminusBaseTreeProps> = ({ rootNode, loading, selectedGuid, onSelect }) => {
  if (loading) {
    return (
...
export default GeminusBaseTree;
