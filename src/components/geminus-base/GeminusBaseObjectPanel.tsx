...
import { GeminusBaseNode, CLASS_LABELS, useGeminusBaseApi } from '@/hooks/useGeminusBaseApi';
...
interface GeminusBaseObjectPanelProps {
  selectedNode: GeminusBaseNode | null;
  onRefresh: () => void;
  onCreateChild?: (parentGuid: string) => void;
}

const GeminusBaseObjectPanel: React.FC<GeminusBaseObjectPanelProps> = ({ selectedNode, onRefresh, onCreateChild }) => {
  const { getObject, updateObject, deleteObject, loading } = useGeminusBaseApi();
  const { toast } = useToast();
  const [detail, setDetail] = useState<GeminusBaseNode | null>(null);
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      The object "{name}" will be permanently deleted from Geminus Base. This action cannot be undone.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
...
export default GeminusBaseObjectPanel;
