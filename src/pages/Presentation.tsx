...
const SolutionSlide = () => (
  <div className="relative w-full h-full overflow-hidden">
    <img src={heroImage} alt="" className="absolute inset-0 w-full h-full object-cover" />
    <div className="absolute inset-0 bg-gradient-to-br from-slate-900/85 to-cyan-950/70" />
    <div className="relative z-10 flex flex-col justify-center h-full text-white px-32 py-20">
...
const ViewerSlide = () => (
  <div className="relative w-full h-full overflow-hidden">
    <img src={heroImage} alt="" className="absolute inset-0 w-full h-full object-cover" />
    <div className="absolute inset-0 bg-gradient-to-br from-slate-900/85 to-indigo-950/70" />
...
const AiDetectionSlide = () => (
  <div className="relative w-full h-full overflow-hidden">
    <img src={heroImage} alt="" className="absolute inset-0 w-full h-full object-cover" />
    <div className="absolute inset-0 bg-gradient-to-br from-slate-900/85 to-emerald-950/70" />
    <div className="relative z-10 flex h-full text-white px-32 py-16">
      <div className="flex-1 flex flex-col justify-center pr-12">
...
const AiAssistantsSlide = () => (
  <div className="relative w-full h-full overflow-hidden">
    <img src={heroImage} alt="" className="absolute inset-0 w-full h-full object-cover" />
    <div className="absolute inset-0 bg-gradient-to-br from-slate-900/85 to-purple-950/70" />
    <div className="relative z-10 flex h-full text-white px-32 py-16">
      <div className="flex-1 flex flex-col justify-center pr-12">
...
const MobileSlide = () => (
  <div className="relative w-full h-full overflow-hidden">
    <img src={heroImage} alt="" className="absolute inset-0 w-full h-full object-cover" />
    <div className="absolute inset-0 bg-gradient-to-br from-slate-900/85 to-orange-950/70" />
    <div className="relative z-10 flex h-full text-white px-32 py-16">
      <div className="flex-1 flex flex-col justify-center pr-12">
