/**
 * Geminus Base Dashboard — Lists drawings and documents from Geminus Base.
 * Route: /geminus-base?building=<fmGuid>
 */
...
const GeminusBaseDashboard: React.FC = () => {
    ...
    return (
      <div className="flex items-center justify-center h-full p-8">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">No building selected. Go to a building and open Geminus Base from there.</p>
    ...
    <div className="h-full overflow-auto p-4 md:p-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-lg font-semibold text-foreground">Geminus Base</h1>
...
export default GeminusBaseDashboard;
